...
hierarchy:
  book: Book Four
  title: Title I - Medical, Dental and Occupational Safety
  chapter: Chapter 1 - Medical and Dental Services
keywords:
  - medical services
  - dental services
  - first aid
...
(c) The services of a full-time physician, dentist and a full-time registered nurse as well as a dental clinic, and an infirmary or emergency hospital with one bed capacity for every 100 employees, when the number of employees exceeds 300.
...
The requirement for an emergency hospital or dental clinic shall not be applicable in case there is a hospital or dental clinic which is accessible from the employer's establishment and he makes arrangements for the reservation therein of the necessary beds and dental facilities for the use of his employees.
